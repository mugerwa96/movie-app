...
export const moviesFetch = createAsyncThunk("movies/moviesFetch",
  async (search) =>
     await axios.get(`https://www.omdbapi.com/?i=tt3896198&apikey=2a909aea&type=movie&s=${search ? search : 'x-men'}`)
         .then(res => res.data.Search)
)

export const moviesFetchById = createAsyncThunk("movies/moviesFetchById",
  async (id) =>
   await   axios.get(`https://www.omdbapi.com/?i=${id}&apikey=2a909aea`)
         .then(res => res.data)
)
